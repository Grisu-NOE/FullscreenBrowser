// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IntToBool.cs" company="Freiwillige Feuerwehr Krems/Donau">
...
namespace At.FF.Krems.Utils.WPF.Converters
{
    ...
    /// <summary>The integer to boolean converter.</summary>
    ...
    public class IntToBool : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return param.Any(x => x == ((int)value).ToString(CultureInfo.InvariantCulture));
        }
