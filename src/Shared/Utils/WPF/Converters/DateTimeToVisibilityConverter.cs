// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DateTimeToVisibilityConverter.cs" company="Freiwillige Feuerwehr Krems/Donau">
...
namespace At.FF.Krems.Utils.WPF.Converters
{
    ...
    /// <summary>The date time to visibility converter.</summary>
    ...
    public class DateTimeToVisibilityConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return value == null || value.Equals(new DateTime()) ? Visibility.Collapsed : Visibility.Visible;
        }
