...
namespace At.FF.Krems.Configuration.Google.StaticMaps.Entities
{
    ...
    /// <summary>The marker style</summary>
    public class MarkerStyle
    {
        /// <summary>
        /// Gets or sets (optional) the size of marker from the set {tiny, mid, small}. If no size parameter is set, the marker will appear in its default (normal) size.
        /// </summary>
        public MarkerSize Size { get; set; }

        /// <summary>
        /// Gets or sets (optional) a 24-bit color (example: color=0xFFFFCC) or a predefined color from the set {black, brown, green, purple, yellow, blue, gray, orange, red, white}.
        ...
        /// <summary>
        /// Gets or sets (optional) a single uppercase alphanumeric character from the set {A-Z, 0-9}. 
